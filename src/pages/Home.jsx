      ...
      <div className="max-w-lg w-full">
        ...
        <div className="flex justify-center items-center gap-4 mb-10 px-4">
          <div className="flex flex-col items-center text-center flex-1">
            ...
            <p className="text-sm font-medium text-gray-700">Enter area</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center flex-1">
            ...
            <p className="text-sm font-medium text-gray-700">Swipe together</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center flex-1">
            ...
            <p className="text-sm font-medium text-gray-700">Get matched</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Choose your area</h3>
            ...
            <form onSubmit={handleZipSubmit} className="mb-4">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-center text-lg font-mono"
                  maxLength={5}
                />
                <button
                  type="submit"
                  disabled={loading || zipCode.length !== 5}
                  className="px-6 py-3 bg-gray-100 hover:bg-gray-200 disabled:bg-gray-50 disabled:cursor-not-allowed text-gray-700 font-medium rounded-lg transition-colors duration-200 border border-gray-300"
                >
                  Go
                </button>
              </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 hover:bg-blue-100 disabled:bg-gray-50 text-blue-700 font-medium rounded-lg transition-colors duration-200 border border-blue-200"
            >
              {loadingLocation ? (
                <>
